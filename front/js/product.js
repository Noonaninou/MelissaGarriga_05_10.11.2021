...
addToCart.addEventListener('click', (event) => {
  ...
  // Si quantity à 0 ou ( || ) color est vide 
  if(selection["quantity"] == 0 || selection["color"] == ""){
    // alors afficher message special
    // calcul du param manquant
    const missing = selection["color"]==""? "couleur" : "quantité";
    // affichage de l'alerte
    alert("Veuillez remplir la " + missing);
    // on return pour ne pas continuer dans le reste de la fonction et donc ne pas l'envoyer au serveur
    return;
  }
